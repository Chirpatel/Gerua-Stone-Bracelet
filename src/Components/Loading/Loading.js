    ...
    return (
        <>
            <svg xmlnsSvg="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg"
                xmlnsXlink="http://www.w3.org/1999/xlink" version="1.0" width={`${width?width:64}px`} height={`${height?height:64}px`} viewBox="0 0 128 128"
                xmlSpace="preserve">
                <rect x="0" y="0" width="100%" height="100%" fill="#FFFFFF" />
                <path fill="#ff9e1e" id="ball1" className="cls-1"
                    ...
                    <animateTransform attributeName="transform" type="rotate"
                        ...
                        dur="1800ms" repeatCount="indefinite"></animateTransform>
                </path>
                <path fill="#ff9e1e" id="ball2" className="cls-1"
                ...
                <path fill="#ff9e1e" id="ball3" className="cls-1"
